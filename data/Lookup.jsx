...
export default {
  ...
  SIGNIN_SUBHEADING: 'To use Webly.io you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using Webly.io, you agree to the collection of usage data for analytics.',
